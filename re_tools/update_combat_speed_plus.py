...
def main() -> int:
    parser: argparse.ArgumentParser = argparse.ArgumentParser(description="Update CombatSpeedPlus.h RVAs and constants from Mewgenics byte signatures.")
    parser.add_argument("exe_path", type=Path, help="Path to the updated Mewgenics executable.")
    parser.add_argument("header_path", type=Path, help="Path to CombatSpeedPlus.h.")
    parser.add_argument("--signatures", type=Path, default=Path("combat_speed_plus_signatures.json"), help="Path to combat_speed_plus_signatures.json.")
