...
#define RVA_REGISTER_SELECTOR        0x97CF80 // Settings-menu selector registration path...
#define RVA_GAME_ALLOCATOR           0x052A40 // Game allocator used for selector option/vector storage...
#define RVA_SETTINGS_SET_STRING      0x9D3660 // Generic settings write helper...
#define RVA_SETTINGS_GET_FLOAT       0x9D3B40 // Generic settings float read helper...
#define RVA_REFRESH_COMBAT_SPEED     0x8E2A30 // Live combat-speed refresh path...
#define RVA_REFRESH_COMBAT_HUD       0x81AEE0 // Combat HUD refresh/update...
#define RVA_FIND_UI_CHILD            0x05A100 // UI child lookup helper...
#define RVA_INIT_NARROW_STRING       0x052AF0 // Constructs a NarrowString...
#define RVA_STRING_DESTRUCTOR        0x052780 // Destroys a NarrowString and frees heap storage...
#define RVA_SET_TEXT_ELEMENT_STRING  0x98E790 // Writes a NarrowString into a text UI element...
#define RVA_SETTINGS_SINGLETON       0x13C4A30 // Global settings-manager singleton pointer...
#define SETTINGS_ROOT_OFFSET         0x3B0 // Offset from the settings-manager singleton to the settings root...
#define COMBAT_HUD_ROOT_OFFSET       0x38 // Offset to combat HUD root...
