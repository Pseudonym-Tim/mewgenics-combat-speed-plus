...
#define RVA_REGISTER_SELECTOR        0x974B50 // Settings-menu selector registration path...
#define RVA_GAME_ALLOCATOR           0x0529F0 // Game allocator used for selector option/vector storage...
#define RVA_SETTINGS_SET_STRING      0x9C9270 // Generic settings write helper...
#define RVA_SETTINGS_GET_FLOAT       0x9C9750 // Generic settings float read helper...
#define RVA_REFRESH_COMBAT_SPEED     0x8DEDE0 // Live combat-speed refresh path...
#define RVA_REFRESH_COMBAT_HUD       0x817320 // Combat HUD refresh/update...
#define RVA_FIND_UI_CHILD            0x05A0B0 // UI child lookup helper...
#define RVA_INIT_NARROW_STRING       0x052AA0 // Constructs a NarrowString...
#define RVA_STRING_DESTRUCTOR        0x052730 // Destroys a NarrowString and frees heap storage...
#define RVA_SET_TEXT_ELEMENT_STRING  0x986360 // Writes a NarrowString into a text UI element...
#define RVA_SETTINGS_SINGLETON       0x13BB790 // Global settings-manager singleton pointer...
